...
static volatile uint64_t limine__requests_start_marker[] = LIMINE_REQUESTS_START_MARKER;
__attribute__((used, section(".limine_requests_end")))
static volatile uint64_t limine__requests_end_marker[] = LIMINE_REQUESTS_END_MARKER;
